  ...
  return (
    <>
      ...
      <div
        ref={popupRef}
        className={cn(
          'fixed bottom-28 right-6 w-[414px] max-w-[calc(100vw-3rem)] bg-popover rounded-lg shadow-2xl z-50',
      ...
      >
        ...
        {/* Content */}
        <div 
          className="overflow-y-auto p-4 bg-popover text-popover-foreground scrollbar-thin scrollbar-track-gray-800 scrollbar-thumb-gray-600 hover:scrollbar-thumb-gray-500" 
