...
export default function Navigation({
  ...
  return (
    <>
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="rounded-full flex items-center justify-center" style={{ width: '56px', height: '56px', backgroundColor: '#101010' }}>
              ...
              >
                ...
                <span
                  className={`block w-6 h-0.5 transition-all duration-300 ease-in-out ${isOpen
      ...
      {/* Expandable Menu */}
      <div
        className={`fixed top-20 left-1/2 transform -translate-x-1/2 z-40 transition-all duration-300 ease-in-out ${isOpen
