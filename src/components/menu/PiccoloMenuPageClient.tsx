...
interface PiccoloMenuPageClientProps {
  initialData: SerializedMenuEntry[];
}

export default function PiccoloMenuPageClient({ initialData }: PiccoloMenuPageClientProps) {
      ...
      <div className="bg-[#000000] text-white font-forum">
        <div className="flex flex-col lg:flex-row relative">
          ...
          <div className="w-full lg:w-1/2 bg-[#000000] pt-[100px] min-h-screen">
            <MenuDisplay restaurantId="piccolo" initialData={initialData} />
          </div>
        </div>
      </div>
